...
ASSET_DATA = [
    ...
    {'ipv6_addresses': [], 'netbios_name': 'SCCM',
     ...
     'network': {'id': '00000000-0000-0000-0000-000000000000',
                 'name': 'Default'}, 'display_ipv4_address': '172.26.48.115',
     'first_observed': '2021-11-02T13:51:20.000Z', 'is_deleted': False,
     ...
     'mac_addresses': ['00:50:56:a6:55:63'], 'types': ['host'],
     'created': '2021-11-02T13:51:30.967Z', 'observation_sources': [
        {'first_observed': '2021-11-02T13:51:20.000Z',
         'last_observed': '2021-11-02T13:51:20.000Z', 'name': 'NESSUS_SCAN'}],
     'is_licensed': True, 'fqdns': ['sccm.target.tenablesecurity.com'],
     'operating_systems': [
     ...
     'display_operating_system':
         'Microsoft Windows Server 2008 R2 Standard Service Pack 1',
     'system_type': 'general-purpose', 'is_public': False, 'name': 'sccm',
     'updated': '2021-11-02T13:51:31.305Z', 'host_name': 'sccm'}]
