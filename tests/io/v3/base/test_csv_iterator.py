...
CSV_TEXT = 'created,display_ipv4_address,first_observed,id,' \
...
CSV_TEXT_2 = 'created,display_ipv4_address,first_observed,id,ipv4_addresses,' \
...
CSV_HEADERS = {
    'Date': 'Wed, 08 Dec 2021 04:42:28 GMT', 'Content-Type':
    'text/csv;charset=UTF-8', 'Content-Length': '508', 'Connection':
    'keep-alive',
    ...
    'Pragma': 'no-cache', 'Expect-CT': 'enforce, max-age=86400',
